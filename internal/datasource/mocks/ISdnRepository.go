...
func (_m *ISdnRepository) Exists(_a0 criteria.SdnCriteria) (bool, error) {
	ret := _m.Called(_a0)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(criteria.SdnCriteria) (bool, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(criteria.SdnCriteria) bool); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(criteria.SdnCriteria) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ISdnRepository) ReadMany(_a0 criteria.SdnCriteria) ([]model.SdnEntity, error) {
	ret := _m.Called(_a0)

	var r0 []model.SdnEntity
	var r1 error
	if rf, ok := ret.Get(0).(func(criteria.SdnCriteria) ([]model.SdnEntity, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(criteria.SdnCriteria) []model.SdnEntity); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
